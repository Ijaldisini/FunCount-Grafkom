...
ctx.new_path()
ctx.move_to(140, 60)   # kiri atas segitiga
ctx.line_to(200, 100)  # tengah kanan segitiga
ctx.line_to(140, 140)  # kiri bawah segitiga
ctx.close_path()
ctx.fill()

surface.write_to_png("assets/button_next.png")
